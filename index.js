...
function getArtistByIndex(array, i) {
    const hat = array[i];
    return `The artist at index ${hat.id} is ${hat.name}`
  }
...
function addArtist(array){
  const me = {
    ...
    bio: 'this is the first sentence because lorem didnt work and i didnt have time to look it up. this is the second sentence because lorum didnt work adn I dont have time to look it up, let than 15min left'
  }
